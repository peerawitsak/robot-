...
class Robot():
    ...
    """
    def update(self):
        self.SenVal = [0,0,0,0,0,0,0,0]
        self.SenVal[0]=GPIO.input(sen1)
        self.SenVal[1]=GPIO.input(sen2)
        self.SenVal[2]=GPIO.input(sen3)
        self.SenVal[3]=GPIO.input(sen4)
        self.SenVal[4]=GPIO.input(sen5)
        self.SenVal[5]=GPIO.input(sen6)
        self.SenVal[6]=GPIO.input(sen7)
        self.SenVal[7]=GPIO.input(sen8)
        
        self.position = patterns.get(tuple(self.SenVal),0)
        self.black_line = patterns_black_line.get(tuple(self.SenVal),0)
    ...
    def Motor_Control(self):
        ...
        #เดินไปข้างหน้าด้วยการ tag แบบ pid
    def Track_forward(self,left_speed,right_speed):
    ...
    def Track_backward(self,left_speed,right_speed):#ส่งค่าความเร็วขวาซ้ายสลับกัน
